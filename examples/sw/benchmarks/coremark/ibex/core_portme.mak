...
port_postbuild:
	riscv64-unknown-linux-gnu-objdump -SD $(OPATH)coremark.elf > $(OPATH)coremark.dis
	riscv64-unknown-linux-gnu-objcopy -O binary $(OPATH)coremark.elf $(OPATH)coremark.bin
